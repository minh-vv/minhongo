...
export default function PageHeader({
  ...
  return (
    <section 
      ...
      style={{ minHeight: minHeight || (children ? undefined : 130) }}
    >
      {/* Gradient background */}
        ...
        <div className="min-w-0 flex-1">
          ...
          {children ? (
            ...
            <div>
              ...
              <h1 
                className="font-headline text-3xl md:text-4xl font-bold text-white leading-tight" 
      ...
      {ghostChar && (
        <div 
          className="absolute -right-4 -bottom-4 font-jp font-bold text-white/[0.04] leading-none select-none pointer-events-none text-[160px]"
        >
          {ghostChar}
        </div>
      )}
