...
async function main() {
  // Let's try NP 1 or 2 or 100
  const url = 'https://www.vnjpclub.com/shinkanzen-n3-bunpo/np-1.html';
  ...
  try {
    ...
    fs.writeFileSync(path.join(__dirname, 'grammar-sample-decrypted.html'), decrypted, 'utf8');
    console.log('Successfully wrote decrypted HTML to grammar-sample-decrypted.html');
  } catch (e: any) {
